  ...
  return function (t) {
    ...
    const a = n.a.Class.extend({
      ...
      _drawTrack: function (t) {
        ...
        this.targetOptions.useImg && this._targetImg ? this._drawShipImage(i, t, this.currentPlaySpeed, this.currentPlayPower, this.currentPlayGsm, this.currentPlayGps, this.currentPlayHeight, this.targetOptions.isDir) : this._drawShipImage(i, t, this.currentPlaySpeed, this.currentPlayPower, this.currentPlayGsm, this.currentPlayGps, this.currentPlayHeight, this.targetOptions.isDir), this.targetOptions.showText && this._drawtxt(`º½Ïò£º${parseInt(i.dir)}¶È`, i), this._showTrackPoint && (this.trackPointOptions.useCanvas ? this._drawTrackPointsCanvas(t) : this._drawTrackPointsSvg(t))
      },
      ...
      _drawShipImage: function (t, b, speed, power, gsm, gps, height, isDir) {
        if (this.targetOptions.replayType) {
          ...
          w = this._ctx.measureText(`${speed+this.targetOptions.unit}`).width + padding
          let h = 26
          obj.lng = t.lng
          obj.lat = t.lat
          ...
          if (window.__wxjs_is_wkwebview) {
            this._ctx.fillText(speed+this.targetOptions.unit, x + (w / 2), y + ((h - 10) / 2) - 3);
          } else {
            this._ctx.fillText(speed+this.targetOptions.unit, x + (w / 2), y + ((h - 10) / 2));
          }
          this._ctx.save(),
